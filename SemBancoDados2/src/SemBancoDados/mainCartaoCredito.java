...
private static void emitirCartaoAdicional() {
        ...
        System.out.print("Digite o ID do titular para emissão do cartão adicional: ");
        int idTitular = scanner.nextInt();
        scanner.nextLine();
        ...
        if (titular != null) {
            ...
            titular.emitirCartaoAdicional(nomeDependente);
            CartaoAdicional cartaoAdicional = new CartaoAdicional(idTitular);
            System.out.println("Cartão Adicional emitido com sucesso para o Titular " + titular.getNomeTitular());
            System.out.println("Cartão Adicional emitido com sucesso para o Dependente " + titular.getCartaoAdicional().getNomeDependente());
        	...
        	System.out.println("Titular não encontrado. Verifique o ID e tente novamente.");
    ...
    private static void consultarFatura() {
        ...
        Titular titular = buscarTitularPorId(idTitular);
        if (titular != null) {
            System.out.println("_________Fatura _________");
            ...
            if (cartaoPrincipal != null) {
                ...
                cartaoPrincipal.consultarFatura();
            }

            CartaoAdicional cartaoAdicional = titular.getCartaoAdicional();
            if (cartaoAdicional != null) {
                System.out.println("Cartão Adicional do dependente " + cartaoAdicional.getNomeDependente());
                
                cartaoAdicional.consultarFatura();
            }
        } else {
            System.out.println("Titular não encontrado. Verifique o ID informado.");
        }
